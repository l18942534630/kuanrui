...
_OesCrdQrySample_PrintClientOverview(OesClientOverviewT  *pClientOverview) {
    ...
    printf(">>> Client Overview: { clientId[%d], " \
            ...
            pClientOverview->isSupportBankFundTrsf,
...
_OesCrdQrySample_PrintBrokerParams(OesBrokerParamsInfoT *pBrokerParams) {
    ...
    printf(">>> Broker Params: { " \
            ...
            "forbidChangePwdBeginTime[%d], forbidChangePwdEndTime[%d], " \
            "minClientPasswordLen[%d], clientPasswordStrength[%d], " \
            ...
            pBrokerParams->forbidChangePwdBeginTime,
            pBrokerParams->forbidChangePwdEndTime,
...
_OesCrdQrySample_OnQryCashAsset(OesApiSessionInfoT *pQryChannel,
    ...
    printf(">>> CashAsset Item: { " \
            ...
            "creditExt:{" \
                ...
                "correctAssetValue[%" __SPK_FMT_LL__ "d], " \
                "trsfOutAbleAssetValue[%" __SPK_FMT_LL__ "d], " \
                "underlyingMarketCap[%" __SPK_FMT_LL__ "d]" \
            "}" \
            "}\n",
            ...
            pCashAssetItem->creditExt.correctAssetValue,
            pCashAssetItem->creditExt.trsfOutAbleAssetValue,
            pCashAssetItem->creditExt.underlyingMarketCap);
...
_OesCrdQrySample_OnQryCrdCreditAsset(OesApiSessionInfoT *pQryChannel,
    ...
    printf(">>> CreditAsset Item: { index[%d], isEnd[%c], " \
            ...
            pCrdAssetItem->otherCreditFee,
            pCrdAssetItem->creditTotalSpecialFee,
            pCrdAssetItem->otherBackedAssetValue,
            pCrdAssetItem->correctAssetValue,
            pCrdAssetItem->trsfOutAbleAssetValue,
            pCrdAssetItem->underlyingMarketCap);
