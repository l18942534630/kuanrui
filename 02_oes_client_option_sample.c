...
/**
 * @file    02_oes_client_option_sample.c
 *
 * OES API接口库的示例程序
 *
 ...
 */
static inline int32
_OesOptSample_SendOrderReq(OesApiSessionInfoT *pOrdChannel,
 ...
 */
static inline int32
_OesOptSample_SendOrderCancelReq(OesApiSessionInfoT *pOrdChannel,
        uint8 mktId, const char *pSecurityId, const char *pInvAcctId,
 ...
 */
static inline int32
_OesOptSample_SendOptSettlementConfirmReq(OesApiSessionInfoT *pOrdChannel,
        const char *pCustId) {
 ...
 */
static int32
_OesOptSample_QueryClientOverview(OesApiSessionInfoT *pSessionInfo) {
    ...
    printf(">>> Client Overview: {clientId[%d], " \
            ...
            "isSupportBankFundTrsf[%" __SPK_FMT_HH__ "u], " \
            "associatedCustCnt[%d]}\n",
            ...
            clientOverview.isSupportBankFundTrsf,
 ...
 */
static int32
_OesOptSample_OnQryOptionCallback(OesApiSessionInfoT *pSessionInfo,
 ...
 */
static inline int32
_OesOptSample_QueryOption(OesApiSessionInfoT *pQryChannel,
    ...
    ret = OesApi_QueryOption(pQryChannel, &qryFilter,
            _OesOptSample_OnQryOptionCallback, NULL);
    if (__spk_unlikely(ret < 0)) {
 ...
 */
static int32
_OesOptSample_OnQryCashAssetCallback(OesApiSessionInfoT *pSessionInfo,
        SMsgHeadT *pMsgHead, void *pMsgBody, OesQryCursorT *pQryCursor,
        void *pCallbackParams) {
    ...
    printf(">>> Recv QryCashRsp: {index[%d], isEnd[%c], " \
            ...
            "ordTrafficFeeAmt[%" __SPK_FMT_LL__ "d], " \
            ...
            pCashAssetItem->feeFrzAmt, pCashAssetItem->ordTrafficFeeAmt,
            pCashAssetItem->optionExt.initialMargin,
            pCashAssetItem->optionExt.totalExerciseFrzAmt,
            pCashAssetItem->marginAmt, pCashAssetItem->marginFrzAmt,
            pCashAssetItem->totalInternalAllotAmt,
 ...
 */
static inline int32
_OesOptSample_QueryCashAsset(OesApiSessionInfoT *pQryChannel,
    ...
    ret = OesApi_QueryCashAsset(pQryChannel, &qryFilter,
            _OesOptSample_OnQryCashAssetCallback, NULL);
    if (__spk_unlikely(ret < 0)) {
 ...
 */
static int32
_OesOptSample_OnQryOptHoldingCallback(OesApiSessionInfoT *pSessionInfo,
        SMsgHeadT *pMsgHead, void *pMsgBody, OesQryCursorT *pQryCursor,
        void *pCallbackParams) {
 ...
 */
static inline int32
_OesOptSample_QueryOptHolding(OesApiSessionInfoT *pQryChannel,
    ...
    ret = OesApi_QueryOptHolding(pQryChannel, &qryFilter,
            _OesOptSample_OnQryOptHoldingCallback, NULL);
    if (__spk_unlikely(ret < 0)) {
 ...
 */
static int32
_OesOptSample_OnQryOptUnderlyingHoldingCallback(OesApiSessionInfoT *pSessionInfo,
        SMsgHeadT *pMsgHead, void *pMsgBody, OesQryCursorT *pQryCursor,
        void *pCallbackParams) {
 ...
 */
static inline int32
_OesOptSample_QueryOptUnderlyingHolding(OesApiSessionInfoT *pQryChannel,
    ...
    ret = OesApi_QueryOptUnderlyingHolding(pQryChannel, &qryFilter,
            _OesOptSample_OnQryOptUnderlyingHoldingCallback, NULL);
    if (__spk_unlikely(ret < 0)) {
 ...
 */
static int32
_OesOptSample_OnQryOptPositionLimitCallback(OesApiSessionInfoT *pSessionInfo,
        SMsgHeadT *pMsgHead, void *pMsgBody, OesQryCursorT *pQryCursor,
        void *pCallbackParams) {
 ...
 */
static inline int32
_OesOptSample_QueryOptPositionLimit(OesApiSessionInfoT *pQryChannel,
        uint8 mktId, const char *pUnderlyingSecurityId) {
    ...
    ret = OesApi_QueryOptPositionLimit(pQryChannel, &qryFilter,
            _OesOptSample_OnQryOptPositionLimitCallback, NULL);
    if (__spk_unlikely(ret < 0)) {
 ...
 */
static int32
_OesOptSample_OnQryOptPurchaseLimitCallback(OesApiSessionInfoT *pSessionInfo,
        SMsgHeadT *pMsgHead, void *pMsgBody, OesQryCursorT *pQryCursor,
        void *pCallbackParams) {
 ...
 */
static inline int32
_OesOptSample_QueryOptPurchaseLimit(
    ...
    ret = OesApi_QueryOptPurchaseLimit(pQryChannel, &qryFilter,
            _OesOptSample_OnQryOptPurchaseLimitCallback, NULL);
    if (__spk_unlikely(ret < 0)) {
 ...
 */
static inline int32
_OesOptSample_QueryOptSettlementStatement(OesApiSessionInfoT *pQryChannel,
        const char *pCustId) {
 ...
 */
static int32
_OesOptSample_OnQryNotifyInfoCallback(OesApiSessionInfoT *pSessionInfo,
        SMsgHeadT *pMsgHead, void *pMsgBody, OesQryCursorT *pQryCursor,
        void *pCallbackParams) {
 ...
 */
static inline int32
_OesOptSample_QueryNotifyInfo(OesApiSessionInfoT *pQryChannel,
    ...
    ret = OesApi_QueryNotifyInfo(pQryChannel, &qryFilter,
            _OesOptSample_OnQryNotifyInfoCallback, NULL);
    if (__spk_unlikely(ret < 0)) {
 ...
 */
static inline int32
_OesOptSample_HandleReportMsg(OesApiSessionInfoT *pRptChannel,
 ...
 */
static inline int32
_OesOptSample_OnTimeout(OesApiClientEnvT *pClientEnv) {
 ...
 */
void*
OesOptSample_ReportThreadMain(OesApiClientEnvT *pClientEnv) {
    ...
    while (! *pThreadTerminatedFlag) {
        ...
        ret = OesApi_WaitReportMsg(pRptChannel, THE_TIMEOUT_MS,
                _OesOptSample_HandleReportMsg, NULL);
        if (__spk_unlikely(ret < 0)) {
            if (__spk_likely(SPK_IS_NEG_ETIMEDOUT(ret))) {
                /* 执行超时检查 (检查会话是否已超时) */
                if (__spk_likely(_OesOptSample_OnTimeout(pClientEnv) == 0)) {
                    continue;
                }
...
OesOptSample_Main() {
...
#if ! (defined (__WINDOWS__) || defined (__MINGW__))
    {
        ...
        retCode = pthread_create(&rptThreadId, NULL,
                (void* (*)(void *)) OesOptSample_ReportThreadMain,
                &cliEnv);
        if (retCode != 0) {
...
#else
    {
        ...
        rptThreadId = CreateThread(NULL, 0,
                (LPTHREAD_START_ROUTINE) OesOptSample_ReportThreadMain,
    ...
    {
        /* 查询 客户端总览信息 */
        _OesOptSample_QueryClientOverview(&cliEnv.qryChannel);

        /* 查询 期权结算单信息 */
        _OesOptSample_QueryOptSettlementStatement(&cliEnv.qryChannel,
                NULL);

        /* 查询 所有关联资金账户的资金信息 */
        _OesOptSample_QueryCashAsset(&cliEnv.qryChannel, NULL);

        /* 查询 指定资金账户的资金信息 */
        /* _OesOptSample_QueryCashAsset(&cliEnv.qryChannel, "指定资金账户"); */

        /* 查询 通知消息 */
        _OesOptSample_QueryNotifyInfo(&cliEnv.qryChannel, NULL, 0);

        /* 查询 期权标的持仓 */
        _OesOptSample_QueryOptUnderlyingHolding(&cliEnv.qryChannel,
                OES_MKT_ID_UNDEFINE, NULL);

        /* 查询 期权限仓额度 */
        _OesOptSample_QueryOptPositionLimit(&cliEnv.qryChannel,
                OES_MKT_ID_UNDEFINE, NULL);

        /* 查询 期权限购额度 */
        _OesOptSample_QueryOptPurchaseLimit(&cliEnv.qryChannel,
                OES_MKT_ID_UNDEFINE);

        /* 查询 上海期权市场 指定期权产品(_SH_OPT_SECURITY_ID) 的产品信息 */
        _OesOptSample_QueryOption(&cliEnv.qryChannel, _SH_OPT_SECURITY_ID,
                OES_MKT_ID_UNDEFINE);

        /* 查询 上海期权市场 全部 的产品信息 */
        //_OesOptSample_QueryOption(&cliEnv.qryChannel, NULL, OES_MKT_SH_OPTION);

        /* 查询 上海期权市场 指定期权产品(_SH_OPT_SECURITY_ID) 的权利仓持仓 */
        _OesOptSample_QueryOptHolding(&cliEnv.qryChannel, OES_MKT_SH_OPTION,
     ...
     */
    {
         ...
         */
        retCode = _OesOptSample_SendOptSettlementConfirmReq(&cliEnv.ordChannel,
                NULL);
        if (retCode != 0) {
            /* 结算单确认失败时直接退出 */
            fprintf(stderr, "期权结算单确认失败, 退出程序! " \
                    "errCode[%d], errMsg[%s]\n",
         ...
         */
        _OesOptSample_SendOrderReq(&cliEnv.ordChannel, OES_MKT_SH_OPTION,
     ...
     */
    {
        ...
        _OesOptSample_SendOrderCancelReq(&cliEnv.ordChannel,
