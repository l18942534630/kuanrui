 ...
 *          - 新增 查询融资融券业务可取资金(OESMSG_QRYMSG_CRD_DRAWABLE_BALANCE) 消息类型定义
 *          - 新增 查询融资融券担保品可转出的最大数量信息(OESMSG_QRYMSG_CRD_COLLATERAL_TRANSFER_OUT_MAX_QTY) 消息类型定义
 *
 * @since   2015/07/30
 */
...
/** 当前采用的协议版本号 */
#define OES_APPL_VER_ID                         "0.17.6.3"
 ...
 */
#define OES_APPL_VER_VALUE                      1001706031
 ...
 * 期权账户结算单确认应答报文
 */
typedef OesOptSettlementConfirmBaseInfoT                                \
...
typedef union _OesQryReqMsg {
    ...
    OesQryColocationPeerCashReqT    qryColoPeerCash;            /**< 查询两地交易COLO对端结点的资金信息请求 */
    ...
    OesQryCrdUnderlyingInfoReqT     qryCrdUnderlyingInfoReq;    /**< 查询融资融券可充抵保证金证券及融资融券标的信息请求 */
    OesQryCrdDrawableBalanceReqT    qryCrdDrawableBalanceReq;   /**< 查询融资融券业务可取资金的请求 */
...
typedef union _OesQryRspMsg {
    ...
    OesQryColocationPeerCashRspT    qryColoPeerCashRsp;         /**< 查询两地交易COLO对端结点的资金信息应答 */
    ...
    OesQryCrdUnderlyingInfoRspT     crdCustUnderlyingInfoRsp;   /**< 查询融资融券可充抵保证金证券及融资融券标的信息应答 */
    OesQryCrdDrawableBalanceRspT    crdDrawableBalanceRsp;      /**< 查询融资融券业务可取资金的应答 */
