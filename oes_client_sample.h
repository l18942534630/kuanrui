...
public:
     ...
     *
     * @param   pCashAsset          查询到的对端结点资金资产信息
     * @param   requestId           对应的查询请求ID (由应用程序在调用查询接口时指定)
     */
    virtual void        OnQueryColocationPeerCashAsset(const OesCashAssetItemT *pCashAsset, int32 requestId);
...
public:
     ...
     * @retval  FALSE               失败
     */
    BOOL                SetDefaultEntrustWay(char entrustWay);
     ...
     * @retval  <0                  失败 (负的错误号)
     */
    int32               QueryColocationPeerCashAsset(const char *pCashAcctId, int32 requestId = 0);
     ...
     * @retval  <0                  失败 (负的错误号)
     */
    int32               QueryColocationPeerCashAsset(OesAsyncApiChannelT *pAsyncChannel, const char *pCashAcctId, int32 requestId = 0);
